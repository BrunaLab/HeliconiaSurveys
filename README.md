...
- These and other validations are also carried out using the [`pointblank`](https://rich-iannone.github.io/pointblank/) package; _The output of the data validation process suggesting records for review is [here_](https://github.com/BrunaLab/HeliconiaSurveys/blob/0675990bb7480055a1287b0cb9f7f7c593b22434/docs/survey_validation/survey_validation.html).
