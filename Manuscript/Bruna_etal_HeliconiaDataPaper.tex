...
\hypersetup{
  pdftitle={Demographic data from 13 populations of the understory herb Heliconia acuminata (Heliconiaceae) in an experimentally fragmented tropical landscape (1997-2013)},
...
\title{\textbf{Demographic data from 13 populations of the understory herb \emph{Heliconia acuminata} (Heliconiaceae) in an experimentally fragmented tropical landscape (1997-2013)}}
...
\def\labelenumi{\arabic{enumi}.}
\item
  \textbf{Storage location and medium:} Ecological Society of America Data Archives {[}URL{]} and the Dryad Digital Repository {[}URL{]}.
\item
...
\item
  \textbf{Alphanumeric attributes:} Mixed.
\item
  \textbf{Special Characters:} Missing values are represented with NA. \textbf{NOTE: What about true blanks? They are NA as well}
\item
...
\noindent  
A. \textbf{Computer programs and data-processing algorithms:} The code used to process the data and prepare it for archiving is archived at Zenodo {[}link{]} and available for continuous improvement at Github (\url{https://github.com/BrunaLab}). The Github repository also includes the up-to-date list of tag changes and any corrections to the dataset made after its archiving.

\noindent  
B. \textbf{Publications and results:} The following articles have included analyses of part or all of the dataset. An update list can be found in the HDP's Github repository (\url{https://github.com/BrunaLab}).
...
\noindent  
This work would not have been possible without the technicians and field assistants participating in the annual surveys, the logistical support provided by the BDFFP staff, and the organizations providing financial support. Sharon Y. Strauss, Susan P. Harrison, and Patricia Delamônica Sampaio provided invaluable feedback during the project's establishment. Charles L. Staines identified the Hispine beetle as \emph{Cephaloleia nigriceps}. This paper is publication number -- -- in the BDFFP Technical Series.
...
Bruna, E. M., W. J. Kress, O. F. da Silva, and F. Marques. 2004. Heliconia acuminata reproductive succeess is independent of local flowering plant density. \emph{Acta Amazonica} 34: 467--471.
...
Gascon, C., and Jr. Bierregaard Richard O. 2001. The {Biological} {Dynamics} of {Forest} {Fragments} {Project}: The study site, experimental design, and research activity. Pages 31--42 Lessons from {Amazonia}: The ecology and conservation of a fragmented forest. Yale University Press, New Haven.
...
Kress, W. J. 1983. Self-incompatibility in central {American} \emph{heliconia}. \emph{Evolution}: 735--744.

\leavevmode\vadjust pre{\hypertarget{ref-lauranceHyperdiverseFloraCentral2001}{}}%
Laurance, W. F. 2001. The hyper-diverse flora of the central {Amazon}. Pages 47--53 \emph{in} R. O. Bierregaard Jr., C. Gascon, T. E. Lovejoy, and R. Mesquita, editors. Lessons from {Amazonia}: {The} ecology conservation of a fragmented forest. Yale University Press, New Haven.
...
Wilcove, D. S., C. H. McLellan, and A. P. Dobson. 1986. Habitat fragmentation in the temperate zone. Pages 237--256. \emph{in} M. E. Soulé, editor. Conservation biology: {The} science of scarcity and diversity. Sinauer Associates, Sunderland.
...
\midrule
plot & Code used to identify a plot & FF1-7: plots in fragments 
  
CF1-6: plots in continuous forest & string\\
\midrule
...
\midrule
bdffp\_no & BDFFP ID Number for the reserve in which plot is located & 2017, 2018, 1104, 1301, 2206, 1202, 3209, 1501, or `NA` (for plots outside BDFFP reserve boundaries) & string\\
\midrule
...
\midrule
plot & Plot in which plant is located (See Table 1) & FF1-7, CF1-6 & - & string\\
\midrule
subplot & Subplot in which plant is located & A1-E10, A6-J10 & - & string\\
\midrule
plant\_id & Unique ID number assigned to each plant & - & 1-8660 & integer\\
\midrule
year & Calendar year in which survey was conducted & - & 1998-2009 & integer\\
\midrule
shts & No. of vegetative shoots a plant has & - & 0-24 & integer\\
\midrule
ht & Distance from ground to height of plant's tallest leaf (in cm) & - & 0-226 & integer\\
\midrule
infl & If reproductive, the number of inflorescences observed during flowering season & - & 1-7 & integer\\
\midrule
recorded\_sdlg & If plant was newly established seedling in survey year & TRUE = seedling
  
FALSE = not a seedling) & - & logical\\
\midrule
found\_without\_tag & If plant was found without a tag in survey & TRUE = established plant with no tag
...
\begin{figure}
\includegraphics[width=1\linewidth]{Bruna_etal_HeliconiaDataPaper_files/figure-latex/map-1} \caption{Satellite image of the Biological Dynamics of Forest Fragments Project showing the location of the \textit{Heliconia} Demographic Plots. Plots are located in Continuous Forest (CF) or Forest Fragments (FF). Dark green is primary forest, light green is regenerating forest, and red indicates pasture and recently cleared areas. For additional details on each plot see Table 1.}\label{fig:map}
\end{figure}

\begin{figure}
\includegraphics[width=1\linewidth]{Bruna_etal_HeliconiaDataPaper_files/figure-latex/fig2-1} \caption{ }\label{fig:fig2}
\end{figure}

\begin{figure}
\includegraphics[width=1\linewidth]{Bruna_etal_HeliconiaDataPaper_files/figure-latex/fig2b-1} \caption{Schematic of the location, orientation, and layout of each \textit{Heliconia} Demographic Plots. The plots are located in Forest Fragments (A-G) or Continuous Forest (H-M).}\label{fig:fig2b}
\end{figure}

\begin{figure}
\includegraphics[width=1\linewidth]{Bruna_etal_HeliconiaDataPaper_files/figure-latex/fig3-1} \caption{ }\label{fig:fig3}
\end{figure}

\begin{figure}
\includegraphics[width=1\linewidth]{Bruna_etal_HeliconiaDataPaper_files/figure-latex/fig3b-1} \caption{Schematic of the location, orientation, and layout of each \textit{Heliconia} Demographic Plots. The plots are located in Forest Fragments (A-G) or Continuous Forest (H-M).}\label{fig:fig3b}
\end{figure}
