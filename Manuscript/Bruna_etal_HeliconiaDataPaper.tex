...
\def\labelenumi{\arabic{enumi}.}
\item
  \textbf{Latest update:} 2022-09-19
\item
  \textbf{Latest archive date:} 2022-09-19 \emph{(to replace with date of archiving at Dryad)}
\item
  \textbf{Metadata status:} Complete (last update: 2022-09-21)
\item
...
\item
  \textbf{Size:} 66785 rows (including header), 3.78
  kilobytes.
\item
