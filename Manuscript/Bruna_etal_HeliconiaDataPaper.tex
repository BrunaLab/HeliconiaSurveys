...
\emph{Word count}: 4760 (text), 1734 (references)
...
\def\labelenumi{\arabic{enumi}.}
\item
  \textbf{Latest update:} 2022-07-29
\item
  \textbf{Latest archive date:} 2022-07-29 \emph{(to replace with date of archiving at Dryad)}
\item
  \textbf{Metadata status:} Complete (last update: 2022-07-29)
\item
