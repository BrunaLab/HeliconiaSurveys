...
\hypersetup{
  pdftitle={Demographic data from populations of the understory herb Heliconia acuminata (Heliconiaceae) in an experimentally fragmented tropical landscape (1997-2009)},
...
\title{\textbf{Demographic data from populations of the understory herb \emph{Heliconia acuminata} (Heliconiaceae) in an experimentally fragmented tropical landscape (1997-2009)}}
...
\emph{Word count}: 4718 (text), 1729 (references)
...
\item
  \textbf{Metadata status:} Complete (last update: 2022-07-27)
\item
