...
heliconia_data <- read_csv("./data_clean/heliconia_dryad.csv", col_types = cols())

# Number of rows in the survey file
file_2_rows <- nrow(heliconia_data)+1 
file_2_size <- (file.info("./data_clean/heliconia_dryad.csv")$size)/1000000
# heliconia_data$code
...
\indent \indent 1.  Data set 1: HDP_plot_descriptors.csv\
\indent \indent 2.  Data set 2: HDP_data_1997-2009.csv\
