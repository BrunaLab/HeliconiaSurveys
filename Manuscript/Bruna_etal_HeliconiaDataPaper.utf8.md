...
<!-- Units, Range, & precision -->

<!-- HA.plot -->

<!-- Seven of the plots are in forest fragments and six are in Continuous Forest. These numbers are used to identify the plots in publications and figures. -->

<!-- string -->

<!-- FF1-7: Forest Fragment plots 1-7 -->

<!-- CF1-6: Continuous Forest plots 1-6 -->

<!-- N/A -->

<!-- HA_ID_Number -->

<!-- Each plant in the database is assigned a unique ID number -->
...
<!-- Plants are marked in the field with a stake to which is marked a numbered aluminum tag. Tag numbers are not duplicated or recycled within a plot.  -->
...
<!-- each demographic plot is subdivided into 50 contiguous subplots arranged in a 5 x 10 grid. “row” identifies the first axis of this grid.  -->
...
<!-- each demographic plot is subdivided into 50 contiguous subplots arranged in a 5 x 10 grid. “row” identifies the second axis of this grid -->
...
<!-- the distance from the ground to the maximum height of the tallest leaf.   -->
...
<!-- the number of vegetative shoots a plant has at the time it is censused  -->
...
<!-- the number of inflorescences produced during a flowering season -->
