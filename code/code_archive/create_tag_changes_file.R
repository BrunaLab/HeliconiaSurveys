...
ha_plots<-read_csv("./data/data_archive/HDP_plots.csv")
# 
# # need to add have the EB plot number as a way of joining the dataset below
# ha_plots_2 <- read_csv("./data/data_clean/heliconia_data_clean.csv") %>% 
#   select(
#     plot_id,
#     plot
#   ) %>%
...
print("The file has been saved to: 'data/data_archive/tag_changes.csv' ")

write_csv(tag_changes, "./data/data_archive/tag_changes.csv")
