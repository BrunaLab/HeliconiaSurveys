create_plant_damage_file <- function() {
# load libraries ----------------------------------------------------------
...
print("The file has been saved to: 'data/survey_clean/plant_damage.csv' ")

write_csv(treefall_impact, "./data/survey_clean/plant_damage.csv")
