clean_heliconia_data <- function() {
  ...
  source("./code/code_cleaning/prep_raw_ha_data.R")
  ...
  source("./code/code_cleaning/merge_with_PA10.R")
  ...
  source("./code/code_cleaning/cleanup_codes.R")
  ...
  source("./code/code_cleaning/check_tags.R")
...
# 
#   source("./code/code_cleaning/check_no_tag.R")
...
# final tweak  ------------------------------------------------------------
  ...
  x <- "\n
    ...
    `data/data_clean/heliconia_data_clean.csv`.
    ------------------------------------------------------------------
    \n"
