...
#' In the resulting table at the end, any failing tests should have a CSV button
#' that lets you see just the rows of data that don't pass.
#'
...
ha %>%
  ...
  col_is_character(vars(plot, 
                        ...
                        code.notes, 
                        code2)) %>%
  col_is_numeric(vars(HA_ID_Number, 
                      tag_number,
                      column, 
                      year, 
                      ht, 
