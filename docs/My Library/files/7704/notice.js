...
setTimeout(function(){h.disconnect()},30000)}})(truste.eu.bindMap);$temp_box_overlay={padding:"0px","border-radius":"0px","box-shadow":"0px 0px 15px 5px #6a6a6a"};
$temp_inner_iframe={"border-radius":"0px"};$temp_overlay={opacity:"0.4"};f.styles={};f.styles.closebtn=typeof $temp_closebtn_style!="undefined"&&$temp_closebtn_style;
...
f.outerdiv=typeof $temp_outerdiv!="undefined";truste.eu.ccpa={};truste.eu.COOKIE_USPRIVACY="usprivacy";
truste.eu.USP_VERSION="1";truste.eu.USP_FILE_NAME="uspapi.js";truste.eu.ccpa.uspString=function(i){var d=truste.eu.bindMap;
var h="1---";if(d.feat.ccpaApplies){var g=/^[nNyY-]$/;var e=(g.test(d.lspa))?d.lspa:"-";i=(i)?"Y":"N";
h=truste.eu.USP_VERSION+"Y"+i+e}return h};truste.eu.ccpa.dropCcpaCookie=function(e){var d=truste.eu.bindMap;
